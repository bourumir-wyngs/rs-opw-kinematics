...
/// Re-export of the `glam` version used by public geometry APIs.
///
/// Downstream crates should import vector and quaternion types from here, for example
/// `rs_opw_kinematics::glam::DVec3`, to avoid type mismatches with another `glam` version.
pub use glam;
