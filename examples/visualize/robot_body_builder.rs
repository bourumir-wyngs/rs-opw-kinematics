...
fn create_Staubli_RS160_joint_bodies() -> [CollisionBody; 6] {
    ...
    [
        CollisionBody::new(load_trimesh_from_stl("src/tests/data/staubli/rx160/link_1.stl").unwrap(), Isometry3::translation(0., 0., 0.)),
        CollisionBody::new(load_trimesh_from_stl("src/tests/data/staubli/rx160/link_2.stl").unwrap(), Isometry3::translation(0., 0., 0.)),
        CollisionBody::new(load_trimesh_from_stl("src/tests/data/staubli/rx160/link_3.stl").unwrap(), Isometry3::translation(0., 0., 0.)),
        CollisionBody::new(load_trimesh_from_stl("src/tests/data/staubli/rx160/link_4.stl").unwrap(), Isometry3::translation(0., 0., 0.)),
        CollisionBody::new(load_trimesh_from_stl("src/tests/data/staubli/rx160/link_5.stl").unwrap(), Isometry3::translation(0., 0., 0.)),
        CollisionBody::new(load_trimesh_from_stl("src/tests/data/staubli/rx160/link_6.stl").unwrap(), Isometry3::translation(0., 0., 0.))
    ]
}
...
pub fn create_sample_robot() -> KinematicsWithShape {
    KinematicsWithShape {
        ...
        body: RobotBody {
            ...
            tool: Some(CollisionBody::new(load_trimesh_from_stl("src/tests/data/flag.stl").unwrap(), Isometry3::identity())),
