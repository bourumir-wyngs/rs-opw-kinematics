...
Since 1.1.0, it is possible to set [constraints](https://docs.rs/rs-opw-kinematics/1.3.7/rs_opw_kinematics/constraints/index.html) for the joints. Robot poses where any of the joints are outside
...
Since 1.3.4, robot can be equipped with the [tool](https://docs.rs/rs-opw-kinematics/1.3.7/rs_opw_kinematics/tool/struct.Tool.html), defined as nalgebra::[Isometry3](https://docs.rs/nalgebra/latest/nalgebra/geometry/type.Isometry3.html). The tool isometry defines both
...
on a [base](https://docs.rs/rs-opw-kinematics/1.3.7/rs_opw_kinematics/tool/struct.Base.html), further supporting the conditions much closer to the real industrial environment.
...
- Joint [velocities](https://docs.rs/rs-opw-kinematics/1.3.7/rs_opw_kinematics/jacobian/struct.Jacobian.html#method.velocities) required to achieve a desired end-effector velocity.
...
There is also more advanced function [rs_opw_kinematics::urdf::from_urdf](https://docs.rs/rs-opw-kinematics/1.3.7/rs_opw_kinematics/urdf/fn.from_urdf.html) 
